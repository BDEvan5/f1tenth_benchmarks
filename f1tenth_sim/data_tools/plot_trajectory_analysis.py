...
class TrajectoryPlotter:
    ...
    def plot_trajectory(self): 
        ...
        xs, ys = self.map_data.xy2rc(self.map_data.t_xs, self.map_data.t_ys)
        ...
        norm = plt.Normalize(0, np.max(self.tracking_accuracy))
...
def plot_trajectory_analysis(vehicle_name):
...
if __name__ == '__main__':
    plot_trajectory_analysis("PpTuning3")

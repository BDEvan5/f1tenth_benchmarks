...
def test_pure_pursuit():
    ...
    test_id = "mu70"
    map_name = "aut"
    planner = GlobalPurePursuit(test_id, False, planner_name="GlobalPurePursuit_Planning")
...
def test_mpcc():
    test_id = "mu70"
    map_name = "aut"
    planner = GlobalMPCC(test_id, True, planner_name="GlobalPurePursuit_Planning")
    test_planning_single_map(planner, map_name, test_id)
    # test_planning_all_maps(planner, test_id)
